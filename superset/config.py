...
APP_ICON = "/static/assets/images/tamra_logo.svg"
...
CONTENT_SECURITY_POLICY_WARNING = False #True

# Do you want Talisman enabled?
TALISMAN_ENABLED = False # utils.cast_to_boolean(os.environ.get("TALISMAN_ENABLED", False))
